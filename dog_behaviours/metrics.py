...
def profile_cil_resources(
    ...
    # ---------- training SRAM (persistent; replay assumed to live in SRAM per your request)
    ...
    # ---------- pack report (keep your existing field names for compatibility)
    report = CILResourceReport(
        ...
        # these names say "int8" in your dataclass; we fill them with deploy bytes (could be 32-bit if passed)
        ...
        replay_buffer_bytes=replay_bytes,                          # SRAM per your assumption
