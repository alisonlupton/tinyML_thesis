...
from models.tuned_mcu_cnn import TunedMCUCILCNN
...
def main():
    ...
    student_path = "../data/dog_breed_data/distillation_mcu_tuned/tuned_mcu_student.pth"
    student_meta_path = "../data/dog_breed_data/distillation_mcu_tuned/tuned_mcu_student_meta.json"
    ...
    backbone_model = TunedMCUCILCNN(3, backbone_num_classes, device, cfg['sparsity_ratio'], student_meta['feature_dim'])
    ...
    # Create CIL model
    cil_model = TunedMCUCILCNN(3, backbone_num_classes, device, cfg['sparsity_ratio'], student_meta['feature_dim']).to(device)
