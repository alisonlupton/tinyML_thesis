...
def main():
    ...
    student_path = "../data/student_from_images/student_backbone_proj.pth"
    student_meta_path = "../data/student_from_images/student_meta.json"
    ...
    # Create backbone model with same architecture
    ...
    # The saved state dict has nested structure, we need to load backbone and proj separately
