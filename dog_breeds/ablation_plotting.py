...
def plot_replay_comparison():
    ...
    #Load both CSV files
    replay_csv = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_withreplay.csv')
    no_replay_csv = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_noreplay.csv')
    replay_no_head_csv = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_withreplay_nohead.csv')
    ...
    if not os.path.exists(replay_no_head_csv):
        print(f"Error: No-replay no-head CSV not found at {replay_no_head_csv}")
    ...
    plt.tight_layout()
    plt.savefig(f'{plot_dir}/dog2_replay_comparison.pdf', bbox_inches='tight')
    plt.close()
    
    print(f"Replay comparison plot saved to {plot_dir}/dog2_replay_comparison.pdf")
...
def plot_p_comparison():
    ...
    #Load both CSV files
    intra10_inter25 = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_10_25.csv')
    intra20_inter45 = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_20_45.csv')
    intra30_inter65 = os.path.join(plot_dir, 'ablations/intelligent_plotting_overall_30_65.csv')
    ...
    plt.tight_layout()
    plt.savefig(f'{plot_dir}/dog2_p_comparison.pdf', bbox_inches='tight')
    plt.close()
...
def plot_per_class_comparison():
    ...
    #Load per-class data
    replay_csv = os.path.join(plot_dir, 'ablations/intelligent_plotting_per_class_withreplay.csv')
    no_replay_csv = os.path.join(plot_dir, 'ablations/intelligent_plotting_per_class_no_replay.csv')
    ...
    plt.tight_layout()
    plt.savefig(f'{plot_dir}/dog2_per_class_replay_comparison.pdf', bbox_inches='tight')
    plt.close()
